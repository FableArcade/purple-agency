...
const SLIDES = [
  ...
  },
  {
    nav: "Engine",
    title: "The Engine",
    description: "AI produces. Humans direct.",
    media: "https://assets.codepen.io/7558/orange-portrait-002.jpg",
    content: {
      heading: "What Comes Out",
      body: "15 ad variants. 5 email sequences. 3 landing pages. Full social calendar. In 48 hours.\nEvery output grounded in your brand via our knowledge system — not generic AI slop.\nCompetitive intel, audience targeting, and performance optimization run continuously.\nEach campaign makes the engine smarter for your next one.",
    },
  },
  {
    nav: "Results",
    title: "Results",
    description: "From brief to live campaigns in 5 days.",
    media: "https://assets.codepen.io/7558/orange-portrait-003.jpg",
    content: {
      heading: "1 Startup. 5 Days. Live Everywhere.",
      body: "Day 1 — Brief and positioning locked.\nDays 2–3 — Engine produces ad creative, email sequences, landing pages, and social content.\nDay 4 — Creative director curates. Growth marketer sets up channels.\nDay 5 — Campaigns live across Google, Meta, LinkedIn, and email.\nNo billable hours. No six-week timelines. Just results.",
    },
  },
  {
    nav: "Services",
    title: "Services",
    description: "Three tiers. One clear entry point.",
    media: "https://assets.codepen.io/7558/orange-portrait-004.jpg",
    content: {
      heading: "Start with a Growth Sprint",
      body: "Growth Sprint — $15–25K/mo. 90 days. Brand strategy, content, competitive intel, GEO audit. For Series A–C startups ready to launch.\nGrowth Engine — $30–75K/mo. Everything above plus paid media, email, social, SEO, landing pages, and reporting. For teams scaling channels.\nEmbedded Pod — $75–150K/mo. Full-service including video, creative testing, CRO, and custom development. For mid-market challengers.\nOutcome-priced retainers. Not billable hours.",
    },
  },
  {
    nav: "Start",
